...
ui <- fluidPage(
  ...
  sidebarLayout(
    ...
    fluidRow(h5("Developers generally love their career path. Whether they like their current job is another story.")),
    fluidRow(
      plotOutput("job_satisfaction_plot"),
      plotOutput("career_satisfaction_plot")
    ),
...
server <- function(input, output){
  surveyResultsPublic <- read.csv("C:/Users/Vinesh/Dropbox/DIT/Higher Diploma/Year 2/Group Project/survey_results_public.csv")
