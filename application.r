...
server <- function(input, output) {
  ...
  surveyResultsPublic <- read.csv("/Users/paukelly/Dropbox/lecturing/GroupProject/stackoverflow_insights/datasets/survey_results_public.csv", stringsAsFactors = FALSE)
  ...
  output$plot <- renderPlot({ggplot(profDeveloperYears, aes(x= Years_Programming, y= Percentage))+ 
